...
app.configure(function(){
  ...
  /*
  app.use("/js", express.static(__dirname ,'/html/customer/js'));
  app.use("/libs", express.static(__dirname ,'/html/customer/libs/'));
  */
...
function serveStaticFile(request, response) {
    ...
    response.sendfile("html/" + request.params.staticFilename);
}
